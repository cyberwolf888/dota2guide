/*!-----------------------------------------------------------------
  ...
  Copyright 2016.
-------------------------------------------------------------------*/
!function(t,a){!function(t){"use strict";
var a=function(a){
	var e=this;
	e.options=a,
	e.$window=t(window),
	e.$document=t(document),
	e.isMobile=/Android|iPhone|iPad|iPod|BlackBerry|Windows Phone/g.test(navigator.userAgent||navigator.vendor||window.opera),
	e.navbarSmall=!1,e.navbarMaxTop=100};
	a.DEFAULT={
		parallax:!0,
		navbarSmall:!1,
		fadeBetweenPages:!0,
	...
	a.prototype.init=function(a){
		function e(){
			o.options.navbarSmall||(o.options.navbarSmall=t(".navbar-youplay").hasClass("navbar-small")),t('[data-toggle="tooltip"]').tooltip({container:"body"}),
