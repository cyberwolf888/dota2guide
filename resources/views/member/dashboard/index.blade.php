...
@section('content')
    ...
    <div class="row widget-row">
            ...
            <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
                ...
                <div class="widget-thumb-wrap">
                    ...
                    <div class="widget-thumb-body">
                        <span class="widget-thumb-subtitle">Subscriber</span>
                        <span class="widget-thumb-body-stat" data-counter="counterup" data-value="{{ $total_subscriber }}">{{ $total_subscriber }}</span>
                    </div>
                </div>
            </div>
            <!-- END WIDGET THUMB -->
        ...
        <div class="col-md-4">
            <!-- BEGIN WIDGET THUMB -->
            <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
                <h4 class="widget-thumb-heading">Total Views</h4>
                <div class="widget-thumb-wrap">
                    <i class="widget-thumb-icon bg-red icon-layers"></i>
                    <div class="widget-thumb-body">
                        <span class="widget-thumb-subtitle">Views</span>
                        <span class="widget-thumb-body-stat" data-counter="counterup" data-value="{{ $total_views }}">{{ $total_views }}</span>
                    </div>
                </div>
            </div>
            <!-- END WIDGET THUMB -->
        ...
        <div class="col-md-4">
            <!-- BEGIN WIDGET THUMB -->
            <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
                <h4 class="widget-thumb-heading">Total Guide</h4>
                <div class="widget-thumb-wrap">
                    <i class="widget-thumb-icon bg-purple icon-screen-desktop"></i>
                    <div class="widget-thumb-body">
                        <span class="widget-thumb-subtitle">Guide</span>
                        <span class="widget-thumb-body-stat" data-counter="counterup" data-value="{{ $total_guide }}">{{ $total_guide }}</span>
                    </div>
                </div>
            </div>
            <!-- END WIDGET THUMB -->
