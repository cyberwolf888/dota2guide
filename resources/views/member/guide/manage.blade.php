                ...
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <div class="btn-group btn-group-devided">
                            <a href="{{ route('member.guide.create') }}" class="btn btn-circle green">
                            ...
                            @foreach($model as $row)
                                <tr>
                                    ...
                                    <td class="center" width="130">
                                        <a href="{{ route('member.guide.edit',$row->id) }}" class="btn yellow-saffron btn-xs"><i class="fa fa-pencil"></i></a>
