            ...
            <div class="portlet light portlet-fit portlet-datatable bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green sbold uppercase">Manage Heros</span>
                    </div>
                    <div class="actions">
                        <div class="btn-group btn-group-devided">
                            <a href="{{ route('admin.hero.create') }}" class="btn btn-circle green">
                    ...
                    <div class="table-container">
                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                            ...
                            @foreach($model as $row)
                                <tr>
                                    <td> {{ $no }} </td>
                                    <td> <img src="{{ $row->img }}" class="img-circle" width="100" height="100"> </td>
                                    <td> {{ $row->name }}</td>

                                    <td class="center" width="130">
                                        <a href="{{ route('admin.hero.edit',$row->id) }}" class="btn yellow-saffron btn-xs"><i class="fa fa-pencil"></i></a>
                                        <a href="{{ route('admin.hero.skill',$row->id) }}" class="btn blue btn-xs"><i class="fa fa-magic"></i></a>
                                        <!-- <a href="{{ route('admin.hero.edit',$row->id) }}" class="btn green btn-xs"><i class="fa fa-eye"></i></a> -->
                                    </td>
                                </tr>
                                <?php $no++ ?>
                            @endforeach
