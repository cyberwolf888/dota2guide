    ...
    <div class="row widget-row">
        <div class="col-md-4">
            ...
            <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
                <h4 class="widget-thumb-heading">Member</h4>
                <div class="widget-thumb-wrap">
                    <i class="widget-thumb-icon bg-green icon-bulb"></i>
                    <div class="widget-thumb-body">
                        <span class="widget-thumb-subtitle">Peaople</span>
            ...
            <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
                ...
                <div class="widget-thumb-wrap">
                    ...
                    <div class="widget-thumb-body">
                        ...
                        <span class="widget-thumb-body-stat" data-counter="counterup" data-value="{{ \App\Models\Guide::count() }}">{{ \App\Models\Guide::count() }}</span>
                    </div>
                </div>
            </div>
            <!-- END WIDGET THUMB -->
        ...
        <div class="col-md-4">
            <!-- BEGIN WIDGET THUMB -->
            <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
                <h4 class="widget-thumb-heading">Total Heros</h4>
                <div class="widget-thumb-wrap">
                    <i class="widget-thumb-icon bg-purple icon-screen-desktop"></i>
                    <div class="widget-thumb-body">
                        <span class="widget-thumb-subtitle">Unit</span>
                        <span class="widget-thumb-body-stat" data-counter="counterup" data-value="{{ \App\Models\Heros::count() }}">{{ \App\Models\Heros::count() }}</span>
                    </div>
                </div>
            </div>
            <!-- END WIDGET THUMB -->
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark bold uppercase">Member</span>
