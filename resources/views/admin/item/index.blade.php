            ...
            <div class="portlet light portlet-fit portlet-datatable bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green sbold uppercase">Manage Items</span>
                    </div>
                    <div class="actions">
                        <div class="btn-group btn-group-devided">
                            <a href="{{ route('admin.item.create') }}" class="btn btn-circle green">
                            ...
                            @foreach($model as $row)
                                <tr>
                                    ...
                                    <td class="center" width="130">
                                        <a href="{{ route('admin.item.edit',$row->id) }}" class="btn yellow-saffron btn-xs"><i class="fa fa-pencil"></i></a>
