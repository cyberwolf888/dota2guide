        ...
        <div id="navbar" class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown dropdown-hover">
                    ...
                    <div class="dropdown-menu">
                        <ul role="menu">
                            <li><a href="https://html.nkdev.info/youplay/documentation">Documentation</a>
                            </li>
                            ...
                            <div class="col-xs-3 col-md-4">
                                <a href="#" class="angled-img">
                                    <div class="img">
                                        ...
                                        <img src="{{ url('assets') }}/frontend/images/game-bloodborne-500x375.jpg" alt="">
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="col-xs-3 col-md-4">
                                <a href="#" class="angled-img">
                                    <div class="img">
                                        ...
                                        <img src="{{ url('assets') }}/frontend/images/game-kingdoms-of-amalur-reckoning-500x375.jpg" alt="">
                                    </div>
                                </a>
                            </div>
                            <div class="col-xs-9 col-md-8">
...
<section class="content-wrap">
    ...
    <section class="youplay-banner banner-top youplay-banner-parallax">
        <div class="image" style="background-image: url('{{ url('assets') }}/frontend/images/banner-bg.jpg')">
        </div>
    ...
    <div class="youplay-carousel" data-autoplay="5000">
        ...
        <a class="angled-img" href="#!">
            <div class="img">
                <img src="{{ url('assets') }}/frontend/images/game-dark-souls-ii-500x375.jpg" alt="">
            </div>
            <div class="over-info">
                <div>
                    <div>
        ...
        <a class="angled-img" href="#!">
            <div class="img">
                <img src="{{ url('assets') }}/frontend/images/game-lords-of-the-fallen-500x375.jpg" alt="">
            </div>
            <div class="over-info">
                <div>
                    <div>
        ...
        <a class="angled-img" href="#!">
            <div class="img">
                <img src="{{ url('assets') }}/frontend/images/game-middle-eart-shadow-of-mordor-500x375.jpg" alt="">
            </div>
            <div class="over-info">
                <div>
                    <div>
        ...
        <a class="angled-img" href="#!">
            <div class="img">
                <img src="{{ url('assets') }}/frontend/images/game-soul-sacrifice-500x375.jpg" alt="">
            </div>
            <div class="over-info">
                <div>
                    <div>
        ...
        <a class="angled-img" href="#!">
            <div class="img">
                <img src="{{ url('assets') }}/frontend/images/game-the-witcher-500x375.jpg" alt="">
            </div>
            <div class="over-info">
                <div>
                    <div>
        ...
        <a class="angled-img" href="#!">
            <div class="img">
                <img src="{{ url('assets') }}/frontend/images/game-diablo-iii-500x375.jpg" alt="">
            </div>
            <div class="over-info">
                <div>
                    <div>
        ...
        <a class="angled-img" href="#!">
            <div class="img">
                <img src="{{ url('assets') }}/frontend/images/game-dragons-dogma-500x375.jpg" alt="">
            </div>
            <div class="over-info">
                <div>
                    <div>
                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        <div class="owl-carousel" data-autoplay="6000">
                            <div class="item">
                                <a href="#">
                                    <img src="{{ url('assets') }}/frontend/images/partner-logo-1.png" alt="">
                                </a>
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img src="{{ url('assets') }}/frontend/images/partner-logo-2.png" alt="">
                                </a>
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img src="{{ url('assets') }}/frontend/images/partner-logo-3.png" alt="">
                                </a>
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img src="{{ url('assets') }}/frontend/images/partner-logo-4.png" alt="">
                                </a>
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img src="{{ url('assets') }}/frontend/images/partner-logo-5.png" alt="">
                                </a>
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img src="{{ url('assets') }}/frontend/images/partner-logo-6.png" alt="">
                                </a>
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img src="{{ url('assets') }}/frontend/images/partner-logo-7.png" alt="">
                                </a>
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img src="{{ url('assets') }}/frontend/images/partner-logo-8.png" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
    ...
    <footer class="youplay-footer-parallax">
        <div class="wrapper" style="background-image: url('{{ url('assets') }}/frontend/images/footer-bg.jpg')">
...
<div class="search-block">
    ...
    <form action="https://html.nkdev.info/youplay/dark/search.html">
...
<!-- Countdown -->
<script type="text/javascript" src="{{ url('assets') }}/frontend/bower_components/jquery.countdown/dist/jquery.countdown.min.js"></script>
