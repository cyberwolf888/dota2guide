        ...
        <div class="page-sidebar navbar-collapse collapse">
            ...
            <ul class="page-sidebar-menu   " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                @can('admin-access')
                    ...
                    <li class="nav-item @if (str_is('*.hero.*', Route::currentRouteName())) active @endif ">
                        <a href="{{ route('admin.hero.manage') }}" class="nav-link ">
                            <i class="icon-rocket"></i>
                            <span class="title">Heros</span>
                        </a>
                    </li>
                    <li class="nav-item @if (str_is('*.item.*', Route::currentRouteName())) active @endif ">
                        <a href="{{ route('admin.item.manage') }}" class="nav-link ">
                            <i class="icon-rocket"></i>
